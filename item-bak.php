...
if ($itemok) {
  ...
  $kuser = new klassica_user($seller_id);
...
<p>
<span class="b">Item #: </span><a href="<?php echo _SITE_URL."/item/$itemid/"; ?>"><?php echo $itemid; ?></a>
<span class="b">
 Listing Started: </span><?php echo $cr_date; ?> 
<span class="b">
Listing Ends: </span><?php echo $expire_date; ?>
</p>
<p>
<span class="b">This item is located in or around: </span><?php echo $location; ?>
</p>
<p>
<span class="b">Seller: </span>
<?php 
// Print username
// WWC Specific: Include link to mask search
$mask_seller_name = urlencode($seller_name);
echo "<a href=\"http://mask.wallawalla.edu/search?name=$mask_seller_name\" target=\"_new\">$seller_name</a>"; 
?>
<br />
<?php
  if ($email) {
    ...
    echo "<span class=\"b\">Email Address:</span> ".protect_email($email_user, $email_domain)."<br />";
  }
  if ($phone) {
    echo "<span class=\"b\">Phone Number:</span> $phone<br />";
  }
?>
</p>
<hr />
...
<p>
<div class="item_info"><span class="b">
  Category: </span><?php echo "<a href=\""._SITE_URL."/listings/$category_id\">$subcat_name</a>"; ?></div>
</p>
<p>
...
<p>
<div class="item_info"><span class="b">
  Price: </span><?php echo $price; ?><?php echo " ".$obo; ?></div>
</p>
<?php
...
<div class="item_info"><span class="b">
  Condition: </span><?php echo $condition; ?></div>
</p>
<?php
} ?>
...
<p>
<div class="item_info"><span class="b">
  Details: </span><?php echo make_html($description); ?></div>
</p>
...
<?php
  ...
  $MAX_FILES = 10;
  $max = min(count($file_arr), $MAX_FILES); // whichever is less
  for ($i = 0; $i < $max; $i++) {
    $file = $file_arr[$i];
    // TODO: Display image only if it of a certain filetype
    echo "<div class=\"item_file\" style=\"display: inline;\">";
    echo "<a href=\""._SITE_URL."/fileupload/$file\" onclick=\"window.open(this.href); return
>> false;\">";
    echo "<img src=\""._SITE_URL."/fileupload/$file\" style=\"float:left; max-height: 250px; padding: 5px;\" />";
    echo "</a>";
    echo "</div>\n";
  }
...
?>
  ...
  <input type="checkbox" name="buy"<?php if ($_POST['buy']) { echo ' checked="checked"';}?> />I want to Buy, Claim, or RSVP to this item.<br />
<?php
...
<?php
    ...
    echo "<div style=\"clear: left;\">";
    echo  "<hr />";
    echo "<h3 class=\"titleLabel\">Please login to reply to this message.</h3>";
    echo "</div>\n";
  }
