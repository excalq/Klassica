...
/* As of 2007-02-20 This was identical to sellform.js, but here the location field 
*  is not required, and there is no price field code */
...
function checkForm() {
  ...
  reqField[1] = document.getElementById("description");
