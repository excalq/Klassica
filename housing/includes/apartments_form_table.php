<form name="apartment-form" action="" method="post" enctype="multipart/form-data">
  <input type="hidden" name="housing-form" value="true">
  <input type="hidden" name="item_category" value="90">
  <table border="0" cellpadding="0" cellspacing="0" id="apartments" class="listings">
    <th>Beds</th>
    <th>Baths</th>
    <th>Rent</th>
    <th>Deposit</th>
